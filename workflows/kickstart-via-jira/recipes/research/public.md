...
- **Programme Context** — strategic placement
- **Reference Implementation** — what has been done before (use as comparison baseline)

Use this context to scope and focus the research — do not research topics unrelated to the initiative's domain.
...
- Improve strategic understanding of the initiative domain
...
If applicable to the initiative domain, research:
...
## 9. Strategic Implications for the Initiative

Clearly connect findings back to the initiative's likely needs.
