...
# Both task-mark-skipped/script.ps1 and src/runtime/Modules/Dotbot.Task/Dotbot.Task.psm1
...
function Update-TaskIndex {
    ...
    foreach ($status in @('todo', 'needs-input', 'in-progress', 'needs-review', 'done', 'split', 'skipped', 'cancelled')) {
