...
$script:SentinelPath = '.bot/src/mcp/dotbot-mcp.ps1'
...
function Test-FrameworkIntegrity {
    ...
    # source repo (src/mcp/modules/) and in target projects
    # (.bot/src/mcp/modules/ after `dotbot init`), so the sibling import is
    # reliable in every real-world context.
