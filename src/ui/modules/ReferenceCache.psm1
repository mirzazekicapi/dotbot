...
function Build-ReferenceCache {
    ...
    foreach ($entry in $allFiles.GetEnumerator()) {
        ...
        # Parse agent directives: @.bot/content/agents/name.md, @.bot/recipes/standards/...
        ...
        # Parse path references: .bot/content/agents/name/AGENT.md, .bot/recipes/standards/global/file.md
