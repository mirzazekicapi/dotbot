...
- Execute research tasks following methodology prompts from `research/`
...
- Follow the research-output quality standard (`.bot/content/workflows/start-from-jira/standards/global/research-output.md`)
